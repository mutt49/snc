...
public class InvoiceHeaderBean {
	...
	public String getLineItemsForInvId() {
		...
		hibernateQuery.setInteger("inv_id", selectedInvId);
	...
	public static void drawS(String line, PDPageContentStream contentStream, int index) throws IOException {
	    ...
	    contentStream.moveTextPositionByAmount(5, 0 + PDPage.PAGE_SIZE_A4.getHeight() - index);
	}
	public ByteArrayOutputStream createPDF() throws IOException,
		...
		try {
			...
			for (int i = 0; i < 1; i++) {
				...
				// Margin
				contentStream.addLine(xOffset + 2, yOffset + 15, xOffset + 2,
						yOffset + height - 2);
				contentStream.addLine(xOffset + 2, yOffset + 15,
						xOffset + width - 2, yOffset + 15);
				contentStream.addLine(xOffset + 2, yOffset + height - 2,
						xOffset + width - 2, yOffset + height - 2);
				contentStream.addLine(xOffset + width - 2, yOffset + 15, xOffset
				...
				contentStream.moveTextPositionByAmount(xOffset + 140, yOffset
						+ height - 93);
				...
				contentStream.beginText();
				contentStream.setFont(fontBold, 10);
				contentStream.moveTextPositionByAmount(xOffset + 50, yOffset
						+ height - 145);
				...
				contentStream.beginText();
				contentStream.setFont(fontBold, 10);
				contentStream.moveTextPositionByAmount(xOffset + 183, yOffset
						+ height - 145);
				...
				contentStream.beginText();
				contentStream.setFont(font, 9);
				contentStream.moveTextPositionByAmount(xOffset + 306 - 16, yOffset
						+ height - 93);
				...
				contentStream.beginText();
				contentStream.setFont(fontBold, 10);
				contentStream.moveTextPositionByAmount(xOffset + 450 - 16, yOffset
						+ height - 93);
				...
				contentStream.moveTextPositionByAmount(xOffset + 450 - 16, yOffset
						+ height - 132);
				contentStream.drawString("AAKFS 2087H ST 001");
				contentStream.endText();
				...
				contentStream.moveTextPositionByAmount(xOffset + 450 - 16, yOffset
						+ height - 145);
				contentStream.drawString("AAKFS2087H");
				contentStream.endText();
				...
				contentStream.moveTextPositionByAmount(xOffset + 306 - 16, yOffset
						+ height - 158);
				contentStream.drawString("MVAT TIN No. : 27160010336 V w.e.f. 1 - 4 - 2006");
				contentStream.endText();
				...
				contentStream.moveTextPositionByAmount(xOffset + 306 - 16, yOffset
						+ height - 171);
				contentStream.drawString("C.S.T. TIN No. : 27160010336 C w.e.f. 1 - 4 - 2006");
				contentStream.endText();
				...
				contentStream.beginText();
				contentStream.setFont(fontBold, 10);
				contentStream.moveTextPositionByAmount(xOffset + 130, yOffset
						+ height - 194);
				contentStream.drawString(selectedInvHdrVo.getCustDetails().getVendor_code());
				contentStream.endText();
				...
				contentStream.moveTextPositionByAmount(xOffset + 12, yOffset
						+ height - 207);
				contentStream.drawString(selectedInvHdrVo.getCustDetails().getCustomer_name());
				contentStream.endText();
				...
				contentStream.moveTextPositionByAmount(xOffset + 12, yOffset
						+ height - 220);
				contentStream.drawString(selectedInvHdrVo.getCustDetails().getCustomer_address());
				contentStream.endText();
				...
				contentStream.moveTextPositionByAmount(xOffset + 63, yOffset
						+ height - 272);
				contentStream.drawString(selectedInvHdrVo.getCustDetails().getEcc_no());
				contentStream.endText();
				...
				contentStream.beginText();
				contentStream.setFont(fontBold, 9);
				contentStream.moveTextPositionByAmount(xOffset + 85, yOffset
						+ height - 285);
				contentStream.drawString(selectedInvHdrVo.getCustDetails().getOctroi_no());
				contentStream.endText();
				...
				contentStream.moveTextPositionByAmount(xOffset + 63, yOffset
						+ height - 298);
				contentStream.drawString(selectedInvHdrVo.getCustDetails().getCst_no());
				contentStream.endText();
				...
				contentStream.moveTextPositionByAmount(xOffset + 63, yOffset
						+ height - 311);
				contentStream.drawString(selectedInvHdrVo.getCustDetails().getBst_no());
				contentStream.endText();
				...
				contentStream.beginText();
				contentStream.setFont(font, 9);
				contentStream.moveTextPositionByAmount(xOffset + 404 - 20, yOffset
						+ height - 194);
				...
				contentStream.beginText();
				contentStream.setFont(fontBold, 10);
				contentStream.moveTextPositionByAmount(xOffset + 458 - 20, yOffset
						+ height - 194);
				contentStream.drawString(Integer.toString(selectedInvHdrVo.getInvId()));
				contentStream.endText();
				...
				contentStream.beginText();
				contentStream.setFont(fontBold, 10);
				contentStream.moveTextPositionByAmount(xOffset + 464 - 20, yOffset
						+ height - 207);
				contentStream.drawString(selectedInvHdrVo.getInvDate().toGMTString());
				contentStream.endText();
				...
				contentStream.addLine(
						Float.valueOf(
								new Double(xOffset + (width * 2.0 / 3.0))
										.toString()).floatValue(), yOffset
								+ height - 215, xOffset + width - 2, yOffset
								+ height - 215);
				...
				contentStream.beginText();
				contentStream.setFont(fontBold, 10);
				contentStream.moveTextPositionByAmount(xOffset + 505 - 20, yOffset
						+ height - 230);
				contentStream.drawString("");
				contentStream.endText();
				...
				contentStream.addLine(
						Float.valueOf(
								new Double(xOffset + (width * 2.0 / 3.0))
										.toString()).floatValue(), yOffset
								+ height - 251, xOffset + width - 2, yOffset
								+ height - 251);
				...
				contentStream.moveTextPositionByAmount(xOffset + 505 - 20, yOffset
						+ height - 266);
				contentStream.drawString(selectedInvHdrVo.getModeOfTransport());
				contentStream.endText();
				...
				contentStream.moveTextPositionByAmount(xOffset + 464 - 20, yOffset
						+ height - 279);
				contentStream.drawString(selectedInvHdrVo.getVehicleNo());
				contentStream.endText();
				...
				contentStream.addLine(
						Float.valueOf(
								new Double(xOffset + (width * 2.0 / 3.0))
										.toString()).floatValue(), yOffset
								+ height - 287, xOffset + width - 2, yOffset
								+ height - 287);
				...
				contentStream.moveTextPositionByAmount(xOffset + 12, yOffset
						+ height - 334);
				contentStream.drawString("Your P.O. No. : " + selectedInvHdrVo.getPurchaseOrderId());
				contentStream.endText();
				...
				contentStream.moveTextPositionByAmount(width - 200, yOffset
						+ height - 334);
				contentStream.drawString("Date : " + selectedInvHdrVo.getPurchaseOrderDate().toGMTString());
				contentStream.endText();
...
*/				
				contentStream.beginText();
				contentStream.setFont(fontBold, 9);
				contentStream.moveTextPositionByAmount(xOffset + 56, yOffset
						+ height - 354);
				contentStream.drawString("Description and specification of goods");
				contentStream.endText();
				...
				contentStream.moveTextPositionByAmount(xOffset + 64, yOffset
						+ height - 365);
//				contentStream.drawString("Proof M/C Non Ferrous Casting");
				contentStream.endText();

				contentStream.addLine(xOffset + 250 + 7, yOffset + height - 340,
						xOffset + 250 + 7, yOffset + height - 600);
				...
				contentStream.beginText();
				contentStream.setFont(fontBold, 9);
				contentStream.moveTextPositionByAmount(xOffset + 253 + 9, yOffset
						+ height - 354);
				...
				contentStream.beginText();
				contentStream.setFont(fontBold, 9);
				contentStream.moveTextPositionByAmount(xOffset + 255 + 9, yOffset
						+ height - 365);
				...
				contentStream.beginText();
				contentStream.setFont(fontBold, 9);
				contentStream.moveTextPositionByAmount(xOffset + 259 + 9, yOffset
						+ height - 376);
				contentStream.drawString("");
				contentStream.endText();
				// Line after No. of Packages
				contentStream.addLine(xOffset + 300 + 9 - 11, yOffset + height - 340,
						xOffset + 300 + 9 - 11, yOffset + height - 600);

				
				contentStream.beginText();
				contentStream.setFont(fontBold, 9);
				contentStream.moveTextPositionByAmount(xOffset + 314 + 9 - 11, yOffset
						+ height - 354);
				...
				contentStream.beginText();
				contentStream.setFont(fontBold, 9);
				contentStream.moveTextPositionByAmount(xOffset + 308 + 9 - 11, yOffset
						+ height - 365);
				contentStream.drawString("in Nos.");
				contentStream.endText();
				// Line after Qnty. in Nos
				contentStream.addLine(xOffset + 345 + 9 - 11, yOffset + height - 340,
						xOffset + 345 + 9 - 11, yOffset + height - 600);

			
				contentStream.beginText();
				contentStream.setFont(fontBold, 9);
				contentStream.moveTextPositionByAmount(xOffset + 354 + 9 - 11, yOffset
						+ height - 354);
				...
				contentStream.beginText();
				contentStream.setFont(fontBold, 9);
				contentStream.moveTextPositionByAmount(xOffset + 350 + 9 - 11, yOffset
						+ height - 365);
				contentStream.drawString("Weight");
				contentStream.endText();
				contentStream.addLine(xOffset + 387 + 9 - 11, yOffset + height - 340,
						xOffset + 387 + 9 - 11, yOffset + height - 600);
				

				contentStream.beginText();
				contentStream.setFont(fontBold, 9);
				contentStream.moveTextPositionByAmount(xOffset + 402 - 11, yOffset
						+ height - 354);
				contentStream.drawString("U.O.M.");
				contentStream.endText();
				contentStream.addLine(xOffset + width - 125 - 11, yOffset + height - 340,
						xOffset + width - 125 - 11, yOffset + height - 600);

				contentStream.beginText();
				contentStream.setFont(fontBold, 9);
				contentStream.moveTextPositionByAmount(xOffset + 452 - 11, yOffset
						+ height - 354);
				contentStream.drawString("Rate per");
				contentStream.endText();
				contentStream.beginText();
				contentStream.setFont(fontBold, 9);
				contentStream.moveTextPositionByAmount(xOffset + 460 - 11, yOffset
						+ height - 365);
				...
				contentStream.beginText();
				contentStream.setFont(fontBold, 9);
				contentStream.moveTextPositionByAmount(xOffset + 520 - 6, yOffset
						+ height - 354);
				contentStream.drawString("Total");
				contentStream.endText();
				...
				contentStream.beginText();
				contentStream.setFont(fontBold, 9);
				contentStream.moveTextPositionByAmount(xOffset + 514 - 6, yOffset
						+ height - 365);
...
/*
				contentStream.beginText();
				contentStream.setFont(fontBold, 9);
				contentStream.moveTextPositionByAmount(xOffset + 435, yOffset
						+ height - 365);0
				contentStream.drawString("U.O.M.");
				contentStream.endText();
				...
				contentStream.beginText();
				contentStream.setFont(fontBold, 9);
				contentStream.moveTextPositionByAmount(xOffset + 425, yOffset
						+ height - 376);
...
*/				
				contentStream.beginText();
				contentStream.setFont(fontBold, 10);
				contentStream.moveTextPositionByAmount(xOffset + width - 60 - 8, yOffset
						+ height - 410);
				...
				contentStream.beginText();
				contentStream.setFont(fontBold, 10);
				contentStream.moveTextPositionByAmount(xOffset + width - 115 - 18, yOffset
						+ height - 410);
				contentStream.drawString("17,78,789.88");
				contentStream.endText();
				...
				contentStream.addLine(xOffset + width - 61 - 11, yOffset + height
						- 340, xOffset + width - 61 - 11, yOffset + 15);
				// Vert Line before P&F
				contentStream.addLine(xOffset + width - 125 - 11, yOffset + height
						- 600, xOffset + width - 125 - 11, yOffset + 15);
				...
				contentStream.moveTextPositionByAmount(xOffset + 12, yOffset
						+ height - 612);
				contentStream.drawString("Total Central Excise Duy Paid (in words): ");
				contentStream.endText();
				...
				drawS ("I/We hereby certify that my/our registration certificate", contentStream, 655);
				contentStream.endText();
				contentStream.beginText();
				contentStream.setFont(font, 7);
				contentStream.moveTextPositionByAmount(xOffset + 5, yOffset
						+ height - 683 + registerOffset);
				drawS ("under the Maharashtra Value Added Tax Act, 2002 is in", contentStream, 655);
				contentStream.endText();				
				...
				drawS ("force on the date which the sale of the goods specified", contentStream, 665);
				contentStream.endText();
				contentStream.beginText();
				contentStream.setFont(font, 7);
				contentStream.moveTextPositionByAmount(xOffset + 5, yOffset
						+ height - 699 + registerOffset);
				drawS ("in this tax invoice is made by me/us and that the transac-", contentStream, 665);
				contentStream.endText();
				contentStream.beginText();
				contentStream.setFont(font, 7);
				contentStream.moveTextPositionByAmount(xOffset + 5, yOffset
						+ height - 707 + registerOffset);
				drawS ("tion of sale convered by this tax invoice has been effected", contentStream, 100);
				contentStream.endText();
				contentStream.beginText();
				contentStream.setFont(font, 7);
				contentStream.moveTextPositionByAmount(xOffset + 5, yOffset
						+ height - 715 + registerOffset);
				drawS ("by me/us and it shall be accounted in the turnover of sales", contentStream, 665);
				contentStream.endText();
				contentStream.beginText();
				contentStream.setFont(font, 7);
				contentStream.moveTextPositionByAmount(xOffset + 5, yOffset
						+ height - 723 + registerOffset);
				drawS ("while filling of return and the due tax, if any, payable on", contentStream, 665);
				contentStream.endText();
				contentStream.beginText();
				contentStream.setFont(font, 7);
				contentStream.moveTextPositionByAmount(xOffset + 5, yOffset
						+ height - 731 + registerOffset);
				contentStream.drawString("the sale has been paid or shall be paid.");
				contentStream.endText();

				// Line between registration and certification
				contentStream.addLine(xOffset + 210, yOffset + height
						- 677, xOffset + 210, yOffset + height - 735 + registerOffset);
				
				// Line below Date & Time of Removal.
				contentStream.addLine(xOffset + 2, yOffset + height
						- 677, xOffset + width - 125 - 11, yOffset + height - 677);

				contentStream.beginText();
				contentStream.setFont(fontBold, 8);
				contentStream.moveTextPositionByAmount(xOffset + 12, yOffset
						+ height - 661);
				contentStream.drawString("Date & Time of Issue of invoice:");
				contentStream.endText();
				...
				contentStream.beginText();
				contentStream.setFont(fontBold, 8);
				contentStream.moveTextPositionByAmount(xOffset + width - 121 - 11, yOffset
						+ height - 628);
				...
				contentStream.beginText();
				contentStream.setFont(fontBold, 10);
				contentStream.moveTextPositionByAmount(xOffset + width - 117 - 11, yOffset
						+ height - 807);
				contentStream.drawString("GRAND");
				contentStream.endText();
				contentStream.beginText();
				contentStream.setFont(fontBold, 10);
				contentStream.moveTextPositionByAmount(xOffset + width - 115 - 11, yOffset
						+ height - 817);
				contentStream.drawString("TOTAL");
				contentStream.endText();
				...
				contentStream.beginText();
				contentStream.setFont(font, 7);
				contentStream.moveTextPositionByAmount(xOffset + 213, yOffset
						+ height - 675 + registerOffset);
				drawS ("Certified that the particulars given above are true and correct", contentStream, 655);
				contentStream.endText();
				contentStream.beginText();
				contentStream.setFont(font, 7);
				contentStream.moveTextPositionByAmount(xOffset + 213, yOffset
						+ height - 683 + registerOffset);
				drawS ("and the amount indicated represents the price acctually", contentStream, 655);
				contentStream.endText();				
				...
				contentStream.moveTextPositionByAmount(xOffset + 213, yOffset
						+ height - 691 + registerOffset);
				drawS ("charged and that there is no flow of additional consideration", contentStream, 665);
				contentStream.endText();
				contentStream.beginText();
				contentStream.setFont(font, 7);
				contentStream.moveTextPositionByAmount(xOffset + 213, yOffset
						+ height - 699 + registerOffset);
				contentStream.drawString ("directly or indirectly from the buyer.");
				contentStream.endText();

				// Line above Excise Duty Payable
				contentStream.addLine(xOffset + 210, yOffset + height - 705 + registerOffset,
						xOffset + width - 113 + registerOffset - 11, yOffset + height - 705 + registerOffset);

				contentStream.beginText();
				contentStream.setFont(fontBold, 10);
				contentStream.moveTextPositionByAmount(xOffset + 216, yOffset
						+ height - 722 + registerOffset);
				contentStream.drawString ("Excise duty payable.");
				contentStream.endText();

				// Line Below Excise Duty Payable
//				contentStream.addLine(xOffset + 2, yOffset + height
//						- 735 + registerOffset, xOffset + 464, yOffset + height - 735 + registerOffset);
				...
				contentStream.setFont(font, 8);
				contentStream.moveTextPositionByAmount(xOffset + 12, yOffset
						+ height - 746 + registerOffset);
				contentStream.drawString ("For");
				contentStream.endText();

				contentStream.beginText();
				contentStream.setFont(fontBold, 8);
				contentStream.moveTextPositionByAmount(xOffset + 28, yOffset
						+ height - 746 + registerOffset);
				...
				contentStream.addLine(xOffset + 150, yOffset + height - 748,
				...
				contentStream.beginText();
				contentStream.setFont(font, 8);
				contentStream.moveTextPositionByAmount(xOffset + 156, yOffset
						+ height - 746 + registerOffset);
				contentStream.drawString ("For");
				contentStream.endText();
				...
				contentStream.beginText();
				contentStream.setFont(fontBold, 8);
				contentStream.moveTextPositionByAmount(xOffset + 172, yOffset
						+ height - 746 + registerOffset);
				contentStream.drawString ("SPIN-N-CAST (Unit - II)");
				contentStream.endText();
				...
				contentStream.addLine(xOffset + 300, yOffset + height - 748,
						xOffset + 300, yOffset + 15);
				
				contentStream.beginText();
				contentStream.setFont(font, 8);
				contentStream.moveTextPositionByAmount(xOffset + 306, yOffset
						+ 34 + registerOffset);
				contentStream.drawString ("Check By");
				contentStream.endText();
				
				// Line after Third box
				contentStream.addLine(xOffset + 370 - 7, yOffset + height - 748,
						xOffset + 370-7, yOffset + 15);
				
				contentStream.beginText();
				contentStream.setFont(font, 8);
				contentStream.moveTextPositionByAmount(xOffset + 376-7, yOffset
						+ 34 + registerOffset);
				contentStream.drawString ("Check By");
				contentStream.endText();
				...
				contentStream.moveTextPositionByAmount(xOffset, yOffset
						+ 5);
				contentStream.drawString ("(Based on C.B.E. & C, Circular No. 29/29/94-CX 6 dt. 21-3-1994)");
				contentStream.endText();

				contentStream.beginText();
				contentStream.setFont(font, 8);
				contentStream.moveTextPositionByAmount(xOffset + width - 130, yOffset
						+ 5);
				contentStream.drawString ("Subject to Pune Jurisdiction only");
				contentStream.endText();
